...
export function SettingsModal({ open, onOpenChange, config, onConfigChange }: SettingsModalProps) {
  ...
  return (
    <>
      ...
      />
      <div className="fixed left-[50%] top-[50%] z-[10003] w-full max-w-sm translate-x-[-50%] translate-y-[-50%] rounded-xl border border-zinc-200 bg-white/70 p-6 shadow-2xl backdrop-blur-2xl dark:border-zinc-800 dark:bg-zinc-950/70 pointer-events-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-[10px] text-zinc-500">
              Run{" "}
              <code className="px-1 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800">ollama list</code>{" "}
