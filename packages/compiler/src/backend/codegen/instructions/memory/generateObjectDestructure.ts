...
import { ObjectDestructureInstruction, getDestructureTargetDefs } from "../../../../ir";
import { CodeGenerator } from "../../../CodeGenerator";
import { generateDestructureTarget } from "./generateDestructureTarget";

export function generateObjectDestructureInstruction(
  instruction: ObjectDestructureInstruction,
